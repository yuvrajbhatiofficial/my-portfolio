  ...
  return (
    <>
      ...
      <nav className="menu  bg-gray-400 py-1 backdrop-filter 
                backdrop-blur-md  bg-opacity-5  text-white flex  justify-between fixed top-0 w-full shadow-xl  ">
        ...
        <ul className=" space-x-4 flex justify-end items-center mx-1 ">
          ...
          <Link className="nav-link" to="./contact"><button className=" font-mono cursor-pointer rounded-lg   hover:scale-105 transition-transform duration-300 ease-in-out px-1">Contact</button></Link>
        </ul>
      </nav>
